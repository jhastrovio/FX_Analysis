"""
Analytics-only consumer dashboard for FX model performance visualization.

This dashboard reads from the FX data estate (read-only) and displays ephemeral
analysis results. It does not modify source data or produce authoritative datasets.
